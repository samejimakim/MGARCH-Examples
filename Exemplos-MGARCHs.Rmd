...
# GO-GARCH  
Nos modelos GO-GARCH, estamos interessados em construir decomposições ortogonais para a matriz $\Sigma_t$. Em outras palavras, buscamos a seguinte igualdade:   
...
Assumiremos que V_t é diagonal e que a variância não-condicional de $\textbf{b}_t$ é a matriz identidade $\textbf{I}_k$.
<font color="red">   
